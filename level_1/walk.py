...
# it takes you one minute to traverse one city block, so create a function that will
...
def is_valid_walk(walk):
    ...
    # for each south there should be a north and for each west an east, and viceversa
    n, s, w, e = 0, 0, 0, 0
    for dir in walk:
        if dir == 'n':
            n += 1
